...
return [
    'default' => 'You have to change the current pin. You not allowed to use the default pin!',
    ...
    'unknown_error' => 'An error has occurred! You won\'t be able to validation this request anymore',
